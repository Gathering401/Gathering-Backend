        ...
        public async Task<TwiMLResult> Index(SmsRequest incomingMessage)
        {
            ...
            switch (Int32.Parse(RsvpResponse))
            {
                ...
                case 3:
                    ...
                    break;
                case 4:
                    messagingResponse.Message($"{invite.Event.EventName} will be on {invite.Event.EventName}. It's located at {invite.Event.Location}. There will {(invite.Event.Food ? "" : "not")} be food. It {(invite.Event.Cost > 0 ? "will cost " + invite.Event.Cost + " dollars" : " is free")}."
