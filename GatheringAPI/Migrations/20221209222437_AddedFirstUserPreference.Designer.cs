...
namespace GatheringAPI.Migrations
{
    ...
    [Migration("20221209222437_AddedFirstUserPreference")]
    partial class AddedFirstUserPreference
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GatheringAPI.Models.EventComment", b =>
                {
                    b.Property<long>("EventId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("GatheringAPI.Models.EventInvite", b =>
                {
                    ...
                    b.HasKey("UserId", "EventRepeatId");

                    b.HasIndex("EventId");

                    b.HasIndex("EventRepeatId");
            ...
            modelBuilder.Entity("GatheringAPI.Models.GroupRepeatedEvent", b =>
                {
                    b.Property<long>("GroupId")
                        .HasColumnType("bigint");
                    ...
                    b.HasKey("GroupId", "EventRepeatId");

                    b.HasIndex("EventRepeatId");

                    b.ToTable("GroupRepeatedEvents");
                });
            ...
            modelBuilder.Entity("GatheringAPI.Models.User", b =>
                {
                    ...
                    b.Property<long>("UpcomingDaysOut")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("GatheringAPI.Models.EventInvite", b =>
                {
                    b.HasOne("GatheringAPI.Models.Event", null)
                        .WithMany("Attending")
                        .HasForeignKey("EventId");
